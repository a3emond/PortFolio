 ...
 *
 *
 * @package    propel.generator.a3emond.Base
 */
abstract class User implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\a3emond\\Map\\UserTableMap';
    ...
    /**
     * The value for the emailadress field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of a3emond\Base\User object.
     */
    ...
    /**
     * Get the [emailadress] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [emailadress] column.
     *
     * @param string $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setEmailadress($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->emailadress !== $v) {
            $this->emailadress = $v;
            $this->modifiedColumns[UserTableMap::COL_EMAILADRESS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserTableMap::translateFieldName('Emailadress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->emailadress = (null !== $col) ? (string) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\a3emond\\User'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($criteria->keyContainsValue(UserTableMap::COL_ID) ) {
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[2] => $this->getEmailadress(),
            $keys[3] => $this->getPassword(),
            $keys[4] => $this->getCreatedAt(),
            $keys[5] => $this->getUpdatedAt(),
        ];
        if ($result[$keys[4]] instanceof \DateTimeInterface) {
            $result[$keys[4]] = $result[$keys[4]]->format('Y-m-d H:i:s');
        }

        if ($result[$keys[5]] instanceof \DateTimeInterface) {
            $result[$keys[5]] = $result[$keys[5]]->format('Y-m-d H:i:s');
        }
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setEmailadress($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_EMAILADRESS)) {
            $criteria->add(UserTableMap::COL_EMAILADRESS, $this->emailadress);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \a3emond\User (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setEmailadress($this->getEmailadress());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \a3emond\User Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return void
     */
    public function resetPartialTasks($v = true): void
    {
     ...
     * @return void
     */
    public function initTasks(bool $overrideExisting = true): void
    {
        ...
        $this->collTasks->setModel('\a3emond\Task');
    }
        ...
        if (null === $this->collTasks || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collTasks) {
                    ...
                    $collTasks->setModel('\a3emond\Task');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countTasks(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collTasksPartial && !$this->isNew();
        if (null === $this->collTasks || null !== $criteria || $partial) {
     ...
     */
    protected function doAddTask(ChildTask $task): void
    {
        $this->collTasks[]= $task;
        $task->setUser($this);
    }
