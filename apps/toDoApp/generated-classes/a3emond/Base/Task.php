...
abstract class Task implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\a3emond\\Map\\TaskTableMap';
    ...
    /**
     * Initializes internal state of a3emond\Base\Task object.
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[TaskTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TaskTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TaskTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TaskTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->updated_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TaskTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\a3emond\\Task'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($criteria->keyContainsValue(TaskTableMap::COL_ID) ) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(TaskTableMap::COL_USER_ID)) {
            $criteria->add(TaskTableMap::COL_USER_ID, $this->user_id);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \a3emond\Task (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \a3emond\Task Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
